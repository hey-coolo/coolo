import { 
  ...
  CourseModule, 
  PartnershipModel 
} from './type'; // Importing from your type.ts file
...
// --- PROJECTS ---
// Note: Category fields updated to match strict ProjectCategory union type
export const PROJECTS: Project[] = [
  {
    ...
    category: 'Brand Identity', // FIXED: Was an array, now strict Union Type
    tags: ['Brutalism', 'Typography', 'Strategy', 'Apparel'],
    year: 2025,
    imageUrl: 'https://cdn.jsdelivr.net/gh/hey-coolo/COOLO@main/assets/cases/unmplymnt/Hero.webp',
    featured: true,
    client: 'Internal Project',
    role: 'Strategy, Identity System, Art Direction',
    detailImages: [
    ...
    story: {
        goal: "UNMPLYNMT began as a belief: that clothing can be more than fashion — it can be a banner for identity, rebellion, and community.",
        gap: "Most streetwear brands dress their ambition in borrowed codes—collegiate fonts, heritage badges. UNMPLYNMT wasn’t about nostalgia or irony.",
        gamble: "We developed a visual voice that mirrors that attitude: Typographic Brutality, Colour Energy, and Texture as Attitude.",
        gain: "Identity done right doesn’t whisper. It moves people. Community turned into culture.",
        processImages: [
