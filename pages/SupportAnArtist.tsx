...
const DropsPage: React.FC = () => {
  ...
  return (
    <div className="w-full bg-brand-offwhite min-h-screen font-sans text-brand-navy selection:bg-brand-navy selection:text-brand-yellow">
      ...
      {/* --- CINEMATIC IMAGE HERO (HALF VERTICAL HEIGHT) --- */}
      <section ref={heroRef} className="relative h-[50vh] w-full overflow-hidden flex flex-col justify-center bg-brand-navy border-b border-brand-navy/20">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-[1600px]">
            <AnimatedSection>
                <div className="font-mono text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] text-brand-yellow mb-4 drop-shadow-md">
                [ The Internal Lab ]
                </div>
                <h1 className="font-sans text-[10vw] lg:text-[6.5rem] font-black uppercase tracking-tighter leading-[0.85] text-brand-offwhite m-0 mb-4 select-none">
                SUPPORT AN<br/>
                <span className="text-transparent stroke-text" style={{ WebkitTextStroke: '2px #F7F7F7' }}>ARTIST.</span>
                </h1>
                <p className="font-body text-sm md:text-xl text-brand-offwhite/80 leading-relaxed font-light max-w-2xl drop-shadow-sm">
