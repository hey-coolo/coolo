                    ...
                    {tier.features.map((item, index) => (
                        <AnimatedSection key={index} delay={index * 50}>
                            <div className="border-l-4 border-brand-navy/10 pl-6 py-2 hover:border-brand-purple transition-colors group">
                                <span className="font-mono text-[10px] uppercase font-bold text-brand-navy/30 mb-2 block group-hover:text-brand-purple">Feature 0{index + 1}</span>
...
export default ClarityTierPage;