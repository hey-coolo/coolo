              ...
              <AnimatedSection>
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                      ...
                      <div className="lg:col-span-5 hidden lg:block">
                          ...
                          {featuredDrop ? (
                              <Link to={`/support-an-artist/${featuredDrop.slug}`} className="block group relative bg-white p-6 shadow-2xl hover:-translate-y-2 transition-transform duration-500">
                                  ...
                                  <div className="mt-6 flex justify-between items-start text-brand-navy">
                                      <div>
                                          <h4 className="font-sans text-2xl font-black uppercase leading-none group-hover:text-brand-purple transition-colors">{featuredDrop.title}</h4>
