...
export const BRAND_CLARITY_TIERS: ClarityTier[] = [
    ...
    { 
        ...
        subtitle: 'Brand strategy core building.',
    ...
    { 
        ...
        subtitle: 'Define your voice and message',
    ...
    { 
        ...
        subtitle: 'We become your creative advisor. Cool or not. Make better communication choices.',
...
export const DESIGN_POWER_TIERS: DesignPowerTier[] = [
    {
        ...
        desc: "You have a business, but you still look like a DIY project. We help you fix that. A logo, some colors and a few fonts picked it for you.",
    ...
    },
    {
        ...
        focus: "All in The Basics + a system built around it. You end up with a robust, well-thought-out brand ecosystem.",
