...
// 1. Handheld Float Animation (The "Camcorder Shake")
const floatAnim = {
    y: [0, -3, 0, 2, 0],
    x: [0, 1, 0, -1, 0],
    transition: {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-start">
                    ...
                    <div className="p-8 md:p-16 space-y-16 md:space-y-32">
                        ...
                        <div className="pt-8 md:pt-16">
                             <Link to="/about" className="inline-block bg-brand-navy text-brand-offwhite px-8 md:px-12 py-5 md:py-6 font-mono text-sm uppercase tracking-widest font-bold hover:bg-brand-purple transition-all duration-300 shadow-[4px_4px_0px_#000]">
                                 Read the Manifesto
                             </Link>
                        </div>
                    </div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="relative z-10 pt-12 border-t border-brand-navy/10 mt-auto">
                                ...
                                <div className="block font-mono text-sm uppercase font-bold tracking-widest border-2 border-brand-navy w-full text-center py-3 group-hover:bg-brand-navy group-hover:text-white transition-colors">
                                    Initialize
                                </div>
                            </div>
                        </Link>
                        ...
                        >
                            ...
                            <div className="flex flex-col md:flex-row gap-12 border-t-2 border-brand-offwhite pt-8 text-brand-offwhite">
                                ...
                                <div className="mt-auto ml-auto">
                                    <span className="font-mono text-sm uppercase tracking-widest bg-brand-offwhite text-brand-navy px-4 py-2 font-bold hover:bg-brand-yellow transition-colors">
                                        Open Case File &rarr;
                                    </span>
                                </div>
                            </div>
    ...
    return (
        ...
        >
            <div className="container mx-auto px-8 relative z-10">
                <div className="mb-24 flex items-end justify-between border-b-2 border-brand-offwhite pb-8">
                     <h2 className="text-6xl md:text-9xl font-black uppercase tracking-tighter leading-[0.9]">
                        Output.
                     </h2>
                     <div className="hidden md:block font-mono text-xs uppercase tracking-widest text-right opacity-80 bg-brand-offwhite text-brand-navy px-2">
                ...
                <div className="flex flex-col">
                    {capabilities.map((cap, index) => (
                        <Link 
                            ...
                            className="group relative border-b border-brand-offwhite/20 py-12 md:py-16 flex flex-col md:flex-row justify-between md:items-center transition-colors hover:bg-white/5"
                        >
                            <div className="flex items-baseline gap-8 md:gap-16">
                                <span className="font-mono text-sm md:text-base text-brand-navy bg-brand-purple group-hover:bg-brand-yellow px-1 font-bold transition-colors">/{cap.id}</span>
                            ...
                            <div className="mt-4 md:mt-0 pl-[calc(2rem+14px)] md:pl-0">
                                <span className="font-mono text-xs md:text-sm uppercase tracking-widest opacity-80 group-hover:opacity-100 transition-opacity text-brand-offwhite group-hover:bg-brand-offwhite group-hover:text-brand-navy px-1">
                                    {cap.desc}
                                </span>
                            </div>
                        </Link>
            ...
            <motion.div
                className="pointer-events-none fixed top-0 left-0 w-[300px] h-[400px] z-50 hidden md:block overflow-hidden bg-brand-yellow mix-blend-difference"
                style={{
                    x: mouseX,
                    y: mouseY,
                    translateX: "-50%",
        ...
        <section className="bg-[#EAEAEA] px-6 md:px-8 py-32 relative z-40 border-b-2 border-brand-navy overflow-hidden">
             <div className="container mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
                     ...
                     <Link to="/work" className="font-mono text-sm uppercase tracking-widest font-bold bg-brand-navy text-brand-offwhite px-8 py-4 hover:bg-brand-purple transition-all shadow-[4px_4px_0px_#000]">
                        View Full Archive
                     </Link>
                </div>

                {/* STAGGERED / BROKEN GRID LAYOUT */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-12">
                    {PROJECTS.slice(1, 8).map((project, index) => (
                        ...
                        >
                             ...
                             {/* Tape Effect */}
                             <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-32 h-8 bg-[#F0F0F0]/80 rotate-2 shadow-sm pointer-events-none z-30"></div>
        ...
        <section className="py-24 relative z-40 bg-[#EAEAEA] overflow-hidden">
             <div className="container mx-auto px-8">
                 <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
                    ...
                    <Link to="/journal" data-cursor-text="INTEL" className="font-mono text-xs uppercase tracking-widest font-bold bg-brand-navy text-white px-2 py-1 hover:bg-brand-purple">View All Entries &rarr;</Link>
                 </div>
                 
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {JOURNAL_POSTS.slice(0, 3).map((post, i) => (
                        <Link key={i} to={`/journal/${post.slug}`} data-cursor-text="READ" className="group block border-2 border-brand-navy p-8 bg-white hover:shadow-[8px_8px_0px_#000] transition-all duration-300">
